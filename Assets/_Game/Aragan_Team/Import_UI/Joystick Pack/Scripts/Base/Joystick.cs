...
{
    public float Horizontal { get { return (snapX) ? SnapFloat(inputVector.x, AxisOptions.Horizontal) : inputVector.x; } }
    public float Vertical { get { return (snapY) ? SnapFloat(inputVector.y, AxisOptions.Vertical) : inputVector.y; } }
